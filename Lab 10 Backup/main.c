...
void display_menu ()
{
	...
	*/
	...
	printf ("16. Create all space breadth lists at once \n") ;
	printf ("17. Print all breadth lists \n") ;
	printf ("18. Exit\n") ;
}
	...
	while (cont)
	{
		...
		switch (option)
		{
			...
			case 9 :
				...
				print_tree_vertical_edgwise (t , t->root, 'r' , 0) ;
				break ;
			...
			case 10 :
				...
				print_tree_vertical_centred (t , t->root , 'r' , 0) ;
				break ;
			...
			case 16 :
				...
				printf ("Space level lists created! \n") ;
